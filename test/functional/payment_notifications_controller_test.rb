...
class PaymentNotificationsControllerTest < ActionController::TestCase
  ...
  test "should create payment_notification" do
    assert_difference('PaymentNotification.count') do
      post :create, payment_notification: { donation_id: @payment_notification.donation_id, params: @payment_notification.params, status: @payment_notification.status }
    end
  ...
  test "should update payment_notification" do
    put :update, id: @payment_notification, payment_notification: { donation_id: @payment_notification.donation_id, params: @payment_notification.params, status: @payment_notification.status }
    assert_redirected_to payment_notification_path(assigns(:payment_notification))
  end
